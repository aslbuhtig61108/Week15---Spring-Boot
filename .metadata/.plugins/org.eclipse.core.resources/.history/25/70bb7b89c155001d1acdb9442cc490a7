...
public class GlobalErrorHandler {
  ...
  public Map<String, Object> handleMethodArgumentTypeMismatchException(
    ...
    return createExeceptionMessage(e, HttpStatus.BAD_REQUEST,webRequest, LogStatus.MESSAGE_ONLY);
  }
  ...
  public Map<String, Object> handleNoSuchElementException(
    ...
    return createExeceptionMessage(e, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
  }
  ...
  public Map<String, Object> handleException(Exception e,
    ...
    return createExeceptionMessage(e, HttpStatus.INTERNAL_SERVER_ERROR, 
   ...
   * @return
   */
  private Map<String, Object> createExeceptionMessage(Exception e,
